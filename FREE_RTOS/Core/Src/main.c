...
int main(void)
{
  ...
  myQueueHandle = osMessageQueueNew(10, sizeof(int), NULL);
  ...
  /* creation of Task1 */
  Task1Handle = osThreadNew(Task, NULL, &Task1_attributes);

  /* creation of Task2 */
  Task2Handle = osThreadNew(myTask2, NULL, &Task2_attributes);
